...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden flex-1 min-w-0 flex-row items-center justify-center space-x-2 text-sm font-medium text-zinc-600 transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-2",
        className,
      )}
    >
      {items.map((item, idx) => (
...
export const NavbarLogo = () => {
  return (
    <Link href="/" className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black">
      <Image
        src="https://png.pngtree.com/png-vector/20241203/ourmid/pngtree-vibrant-holographic-music-note-floating-against-a-transparent-background-generative-ai-png-image_13643529.png"
        alt="Musicle logo"
        width={30}
        height={30}
        unoptimized
